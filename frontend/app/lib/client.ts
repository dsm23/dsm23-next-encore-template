...
export function Environment(name: string): BaseURL {
  return `https://${name}-next-js-test-ts-9wvi.encr.app`;
}
...
/**
 * Client is an API client for the next-js-test-ts-9wvi Encore application.
 */
...
export namespace auth {
  ...
  export class ServiceClient {
    ...
    public async login(params: LoginParams): Promise<{
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI("GET", `/login`, undefined, {
        query,
      });
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "next-js-test-ts-9wvi-Generated-TS-Client (Encore/v1.36.3)";
    }
